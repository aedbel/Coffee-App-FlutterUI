...
import 'package:coffeapp/models/products.dart';
import 'package:coffeapp/screen/product_details.dart';
...
class _MainScreenState extends State<MainScreen> {
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.ubuntu(
                  color: IconColor, fontSize: 25, fontWeight: FontWeight.w600),
            ),
            SizedBox(
              height: defaultPadding,
            ),
            ...
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return TopProducts(demoProducts[index]);
                  }),
            ),
            SizedBox(
              height: defaultPadding,
  ...
  Padding TopProducts(Products products) {
    return Padding(
      padding: const EdgeInsets.only(right: defaultPadding),
      child: Container(
        height: 300,
